...
AUTHORITY="GTCJmbURDU42opNv7nzjT5dZ4SJ2VoYLr2r9LQYbB5uW"
D3X_MINT="AGN8SrMCMEgiP1ghvPHa5VRf5rPFDSYVrGFyBGE1Cqpa"
NETWORK="${1:-mainnet-beta}"  # Default to mainnet-beta now
...
const ORACLE_PUBKEY = new PublicKey("37De9qFqKoyPDoM4eCWCGKkgAFFxBtJYQNJjHmL9wK8k");

const connection = new anchor.web3.Connection(anchor.web3.clusterApiUrl("mainnet-beta"), "confirmed");
